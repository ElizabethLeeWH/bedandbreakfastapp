...
public class BnBController {
	...
	@PostMapping(path ="/accommodation", consumes="application/json", produces = "application/json")
	@ResponseBody
	public ResponseEntity<String> createBooking(@RequestBody Map<String, String> body){
		
		Bookings b = new Bookings();
		b.setEmail(body.get("email"));
		b.setListingId(body.get("id"));
		b.setName(body.get("name"));
		b.setDuration(Integer.parseInt(body.get("nights")));
